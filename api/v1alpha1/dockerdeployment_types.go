...
type DockerContainerTemplate struct {
	// Standard object's metadata (labels/annotations for child DockerContainers).
	// +optional
...
// ObjectMeta is a slim metadata used inside DockerContainerTemplate.
...
// It manages N DockerContainer replicas from a template (like a K8s Deployment).
